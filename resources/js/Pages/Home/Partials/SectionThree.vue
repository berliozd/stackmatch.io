    ...
    <section class="text-center md:p-12 p-6">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
            <div class="w-full md:w-48 flex flex-col gap-2">
                ...
                <p class="font-bold">I don't know how to identify my potential customers</p>
            </div>
            ...
            <div class="w-full md:w-48 flex flex-col gap-2">
                <span class="text-4xl">😤</span>
                <p class="font-bold">I have to go through a long and often unsuccessful qualification process</p>
            </div>
            ...
            <div class="w-full md:w-48 flex flex-col gap-2">
                <span class="text-4xl">🤬</span>
                <p class="font-bold">I need to find a tool that helps me find clients</p>
            </div>
        </div>
    </section>
</template>
